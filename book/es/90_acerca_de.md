...
Este sitio está escrito en archivos Markdown y notebooks de Jupyter, y se convierte a HTML y PDF usando herramientas del ecosistema [TeachBooks](https://teachbooks.io/), [Jupyter Book](https://jupyterbook.org/) y [MyST Markdown](https://mystmd.org/).
